...
* 「清松手寫體1」ver 1.37，Max額外增6,572字，目前總字數：17,577字（和符號）。（參考[jason1_new_glyph.txt](https://github.com/max32002/JasonHandWritingFonts/raw/master/jason1_new_glyph.txt)）
* 「清松手寫體2」ver 1.04，Max額外增7,611字，目前總字數：14,721字（和符號）。（參考[jason2_new_glyph.txt](https://github.com/max32002/JasonHandWritingFonts/raw/master/jason2_new_glyph.txt)）
* 「清松手寫體3」ver 1.22，Max額外增7,304字，目前總字數：12,479字（和符號）。（參考[jason3_new_glyph.txt](https://github.com/max32002/JasonHandWritingFonts/raw/master/jason3_new_glyph.txt)）
