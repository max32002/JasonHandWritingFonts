...
* 「清松手寫體1」ver 1.38，Max增加（或更新）中文9,836字，增加符號4,802字，目前總字約：24,000字（和符號）。（參考[jason1_new_glyph.txt](https://github.com/max32002/JasonHandWritingFonts/raw/master/jason1_new_glyph.txt)）
...
附註3：「清松手寫體4」使用由cjkFont 所製作的「cjkFonts 手寫4」應該會是更好的選擇。
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/JasonHandWritingFonts@20200920/webfont/JasonHandwriting1-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/JasonHandWritingFonts@20200920/webfont/JasonHandwriting1-Regular.woff) format("woff");
}
```
